...
namespace UFE3D
{
	...
	public struct CreateMatchResponse
	{
		...
		public CreateMatchResponse(string accessTokenString, bool success)
		{
			this._success = success;
	...
	public abstract class MultiplayerAPI : MonoBehaviour
	{
		...
		public class CreatedMatchInformation
		{
			...
			public CreatedMatchInformation(string matchName) {
				this.matchName = matchName;
			}
		}
		...
		public class JoinedMatchInformation
		{
			...
			public JoinedMatchInformation() : this(null) { }
			...
			public JoinedMatchInformation(string matchName)
			{
				this.matchName = matchName;
			}
		}
		...
		public class MatchInformation
		{
			...
			{
				this.connections.Add(new ConnectionInformation(address, address, port));
			}

			public MatchInformation(string privateAddress, string publicAddress, int port)
			{
				this.connections.Add(new ConnectionInformation(privateAddress, publicAddress, port));
			}
