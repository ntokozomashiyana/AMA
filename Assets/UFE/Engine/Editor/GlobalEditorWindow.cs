                        ...
                        if (guiScreensOptions) {
							...
							EditorGUILayout.BeginVertical(this.subGroupStyle);{
								...
								EditorGUI.BeginDisabledGroup(!UFE.isNetworkAddonInstalled && !UFE.isBluetoothAddonInstalled);{
                                    ...
                                    EditorGUILayout.BeginHorizontal();{
                                        globalInfo.gameGUI.searchMatchScreen = (QuickMatchScreen)EditorGUILayout.ObjectField("Quick Match:", globalInfo.gameGUI.searchMatchScreen, typeof(QuickMatchScreen), true);
